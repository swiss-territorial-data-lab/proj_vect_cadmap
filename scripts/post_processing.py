...
def parse_args():
    ...
    parser.add_argument('--semantic',     
                        default="./data/semantic_prediction_mask/Cartigny/",
                        # default="./data/semantic_prediction_mask/Carouge/",
    ...
    parser.add_argument('--save',
                        default="./data/vectorized_results/Cartigny",
                        # default="./data/vectorized_results/Carouge",
