...
model = dict(
    ...
    decode_head=dict(num_classes=7, in_channels=[112, 224, 448, 896],
                    loss_decode=dict(
                ...
                #                   use_sigmoid=True,
                #                   loss_weight=1.0)),
    auxiliary_head=dict(num_classes=7, in_channels=448),
    test_cfg=dict(mode='whole')
)
optimizer = dict(
    _delete_=True, type='AdamW', lr=5e-7, betas=(0.9, 0.999), weight_decay=0.05,
