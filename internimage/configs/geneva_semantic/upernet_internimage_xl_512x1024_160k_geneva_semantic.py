...
# --------------------------------------------------------
_base_ = [
    '../_base_/models/upernet_r50.py', '../_base_/datasets/geneva_semantic.py',
...
model = dict(
    ...
    decode_head=dict(num_classes=7, in_channels=[192, 384, 768, 1536]),
    auxiliary_head=dict(num_classes=7, in_channels=768),
    test_cfg=dict(mode='slide', stride=(256, 512), crop_size=(512, 1024), threshold=0.01))
optimizer = dict(
